  ...
  return (
    <main className="min-h-screen font-sans text-[#f3e5e5] bg-gradient-to-br from-[#0f0f0f] via-[#2a003f] to-[#ff5f00] p-6 md:p-12">
      ...
      <section className="text-center space-y-4 mb-10">
        <motion.h1
          className="text-5xl font-extrabold text-[#ECD9B0]"
      ...
      <section className="mb-12 bg-white/10 rounded-xl p-6 shadow-md border border-[#f3e5e5]/20">
        <h2 className="text-3xl font-bold text-[#ECD9B0] mb-2">🚀 Pikkpro — Simplifying Service Access</h2>
        <p>
      ...
      <section className="mb-12">
        <h2 className="text-2xl font-bold mb-4 text-[#ECD9B0]">📁 Projects In Progress</h2>
      ...
      {/* Experience */}
      <section className="mb-12">
        <h2 className="text-2xl font-bold mb-4 text-[#ECD9B0]">🏢 Experience</h2>
      ...
      {/* About */}
      <section className="mb-12">
        <h2 className="text-2xl font-bold mb-4 text-[#ECD9B0]">👩‍💻 About Me</h2>
        <p className="text-sm">
      ...
      <section className="text-center">
        <h2 className="text-2xl font-bold mb-2 text-[#ECD9B0]">✍️ Blog</h2>
